...
mzPeakFileNameList <- list(
    c('2021-11-23/25DHB+SPCS-100%EtOH-20210908/0_H1/1/Spectrum_processed-peaks.csv',
      '2021-11-23/25DHB+SPCS-100%EtOH-20210908/0_H2/1/Spectrum_processed-peaks.csv',
      '2021-11-23/25DHB+SPCS-100%EtOH-20210908/0_H3/1/Spectrum_processed-peaks.csv',
      '2021-11-23/25DHB+SPCS-100%EtOH-20210908/0_H4/1/Spectrum_processed-peaks.csv',
      '2021-11-23/25DHB+SPCS-100%EtOH-20210908/0_H5/1/Spectrum_processed-peaks.csv'),
    c('2021-11-23/25DHB+SerumExtract-100%EtOH-20210908/0_I1/1/Spectrum_processed-peaks_noBG.csv',
      '2021-11-23/25DHB+SerumExtract-100%EtOH-20210908/0_I2/1/Spectrum_processed-peaks_noBG.csv',
      '2021-11-23/25DHB+SerumExtract-100%EtOH-20210908/0_I3/1/Spectrum_processed-peaks_noBG.csv',
      '2021-11-23/25DHB+SerumExtract-100%EtOH-20210908/0_I4/1/Spectrum_processed-peaks_noBG.csv',
      '2021-11-23/25DHB+SerumExtract-100%EtOH-20210908/0_I5/1/Spectrum_processed-peaks_noBG.csv')
)
mzPeakFileNameList <- addParentDirectory(mzPeakFileNameList, mzDataDir)

mzDestPeakFileName <- c(
    '25DHB+SPCS-100%EtOH-20210908.csv',
    '25DHB+SerumExtract-100%EtOH-20210908_noBG.csv'
)
