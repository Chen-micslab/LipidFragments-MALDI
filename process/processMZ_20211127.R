...
mzOrigFilenameList <- list(
    c('2021-11-27/TiO2NP25+EtOH+NaCl-MS2/0_A14/1/104.1000.LIFT/Spectrum.mzXML'),
    c('2021-11-27/TiO2NP25+NaCl+PC(18(0)-18(2))-MS2/0_B13/1/166.1000.LIFT/Spectrum.mzXML'),
    c('2021-11-27/TiO2NP25+NaCl+PC(18(0)-18(2))-MS2/0_B14/1/104.1000.LIFT/Spectrum.mzXML')
)
...
mzBackgroundPeakFilenameList <- list(
    c(),
    c('2021-11-27/TiO2NP25+EtOH+NaCl-MS2/0_A14/1/104.1000.LIFT/Spectrum.mzXML'),
    c('2021-11-25/TiO2NP25+EtOH+NaCl-MS2/0_F4/1/166.1000.LIFT/Spectrum.mzXML')
)
