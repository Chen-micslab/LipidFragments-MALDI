...
mzOrigFileName <- c(
    '20211017/SerumExtract-100%EtOH-20210908-positive.mzML',
    '20211017/SerumExtract-100%EtOH-20210908-positive-2.mzML',
    '20211017/SerumExtract-100%EtOH-20210908-positive-3.mzML',
    '20211017/SerumExtract-50%CHCl3-50%MeOH-20210908-positive.mzML',
    '20211017/SerumExtract-50%CHCl3-50%MeOH-20210908-positive-2.mzML',
    '20211017/SerumExtract-50%CHCl3-50%MeOH-20210908-positive-3.mzML'
)
...
mzExtractSpectrumIDList <- c(
    ...
    # With column
    # RT = 75.22 ~ 80.67 sec; Scan = 340 ~ 365 (Carnitine/d3-Carnitine@SE1)
    # RT = 75.02 ~ 80.52 sec; Scan = 336 ~ 361 (Carnitine/d3-Carnitine@SE2)
    rep(list(c(340:365)), 3),
    rep(list(c(336:361)), 3)
)
