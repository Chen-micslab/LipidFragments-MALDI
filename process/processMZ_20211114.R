...
mzOrigFilenameList <- list(
    c('2021-11-14/TiO2NP25+EtOH+NaCl-MS2/0_O19/1/111.1000.LIFT/Spectrum.mzXML',
      '2021-11-14/TiO2NP25+EtOH+NaCl-MS2/0_O19/1/123.1000.LIFT/Spectrum.mzXML'),
    c('2021-11-14/TiO2NP25+NaCl+PE(18-18)-MS2/0_O20/1/111.1000.LIFT/Spectrum.mzXML',
      '2021-11-14/TiO2NP25+NaCl+PG(18(0)-18(1))-MS2/0_P20/1/111.1000.LIFT/Spectrum.mzXML'),
    c('2021-11-14/TiO2NP25+NaCl+PG(18(0)-18(1))-MS2/0_P22/1/123.1000.LIFT/Spectrum.mzXML')
)
...
mzBackgroundPeakFilenameList <- list(
    c(),
    c('2021-11-14/TiO2NP25+EtOH+NaCl-MS2/0_O19/1/111.1000.LIFT/Spectrum.mzXML'),
    c('2021-11-14/TiO2NP25+EtOH+NaCl-MS2/0_O19/1/123.1000.LIFT/Spectrum.mzXML')
)
