...
# mzPlotFilename <- 'TiO2NP25+PC(18-18)+SE1_zoomYx4.png'
...
# mzPlotRangeY <- c(0, 0.25)
# mzPlotRangeY <- c(0, 0.01)
# mzPlotRangeY <- c(0, 0.015)
...
p <- p + theme_bw() + 
    theme(text = element_text(size = mzPlotFontSize),
          ...
          # plot.margin = margin(t = 2, r = 4, b = 2, l = 4.27, unit = 'line')
         )
p <- p + 
